...
import vti.anhtrantuan1.domain.Product;
import vti.anhtrantuan1.model.ReportInventory;
...
//	Page<Product> findAllByCategory(Pageable page);
	...
	@Query("select new vti.anhtrantuan1.model.ReportInventory(o.category, sum(o.unitPrice), sum(o.quantity)) from Product o group by o.category order by sum(o.quantity) desc")
